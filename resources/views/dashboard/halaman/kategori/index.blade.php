            ...
            <div class="col-md-12">
                ...
                <div class="card-header">
                    <div class="row justify-content-between">
                        ...
                        <a href="{{route('tambah-kategori')}}" class="btn btn-primary"><i class="fa fa-user-plus"></i> Tambah </a>
                    </div>
                    <div class="search-bar">
                      <form class="search-form d-flex align-items-center" method="get" action="{{route('cari-kategori')}}">
                          ...
                          <tr>
                              ...
                              <td class="text-center">
                                  <div class="btn-group">
                                      ...
                                      <a href="{{route('hapus-kategori', ['id'=> $item->id])}}" data-confirm-delete="true" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Hapus </a>
                                  </div>
                              </td>
                          </tr>
                        @endforeach
