            ...
            <div class="col-md-12">
                ...
                <div class="card-header">
                    <div class="row justify-content-between">
                        ...
                        <a href="{{route('tambah-barang-keluar')}}" class="btn btn-primary"><i class="fa fa-user-plus"></i> Tambah </a>
                    </div>
                    <div class="search-bar">
                      <form class="search-form d-flex align-items-center" method="get" action="{{route('cari-barang-keluar')}}">
                          ...
                          <tr>
                              ...
                              <td class="text-center">
                                  <div class="btn-group">
                                      ...
                                      <a href="{{route('hapus-barang-keluar', ['id'=> $item->id])}}" data-confirm-delete="true" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Hapus </a>
                                  </div>
                              </td>
                          </tr>
                        @endforeach
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="detailBarangModalLabel">Detail Barang Keluar</h5>
...
<script>
    $(document).ready(function() {
      $('#detailBarangModal').on('show.bs.modal', function(event) {
        ...
        $.ajax({
          url: "{{ route("detail-barang-keluar", ['id' => ':id']) }}".replace(':id', id), // Ganti route sesuai dengan route Anda
          type: 'GET',
          data: {
            id: id
          },
