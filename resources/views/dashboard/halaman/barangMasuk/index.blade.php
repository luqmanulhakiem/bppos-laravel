                          ...
                          <tr>
                              ...
                              <td class="text-center">
                                  <div class="btn-group">
                                      ...
                                      <a href="{{route('hapus-barang-masuk', ['id'=> $item->id])}}" data-confirm-delete="true" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Hapus </a>
                                  </div>
                              </td>
                          </tr>
                        @endforeach
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="detailBarangModalLabel">Detail Barang Masuk</h5>
...
<script>
    $(document).ready(function() {
      $('#detailBarangModal').on('show.bs.modal', function(event) {
        ...
        $.ajax({
          url: "{{ route("detail-barang-masuk", ['id' => ':id']) }}".replace(':id', id), // Ganti route sesuai dengan route Anda
          type: 'GET',
          data: {
            id: id
          },
