...
class BarangKeluarController extends Controller
{
    ...
    {
        $data = BarangInOut::with(['barang', 'penyuplai', 'user'])->where('status', 'keluar')->latest()->paginate(10);

        // Alert Konfirmasi
        $title = 'Hapus Barang keluar!';
        $text = "Apakah Kamu Yakin, data barang keluar berelasi dengan data lain?";
        confirmDelete($title, $text);

        // menampilkan data yang sudah diambil ke tampilan
        return view('dashboard.halaman.barangKeluar.index', compact('data'));
    }
    ...
    **/
    public function search(Request $request)
    {
        ...
        $data = BarangInOut::with(['barang', 'penyuplai', 'user'])->where('status', 'keluar')
    ...
    public function create()
    {
        ...
        return view('dashboard.halaman.barangKeluar.create', compact(['barang', 'penyuplai']));
    }
    ...
    public function searchBarang(Request $request)
    {
        ...
        return view('dashboard.halaman.barangKeluar.barang-list', compact('barang'));
    }
    ...
    {
        $detail = BarangInOut::with(['barang', 'penyuplai', 'user'])->where('id', $id)->where('status', 'keluar')->first();
